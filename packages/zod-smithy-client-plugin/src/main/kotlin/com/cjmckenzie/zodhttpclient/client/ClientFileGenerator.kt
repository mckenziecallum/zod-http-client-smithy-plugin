package com.cjmckenzie.zodhttpclient.client
...
class ClientFileGenerator {
    private val logger = Logger.getLogger(ClientFileGenerator::class.java.name)
        ...
        val content =
            buildString {
                ...
                methods.forEach { method ->
                    ...
                    appendLine("      });")
                    appendLine("      const method: string = req.method;")
                    ...
                    appendLine("        ...(method !== 'GET' && method !== 'HEAD' && Object.keys(req.body).length > 0")
